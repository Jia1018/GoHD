...
class Synthesis(nn.Module):
    def __init__(self, size, style_dim, motion_dim, output_nc = 3, use_sft = False, blur_kernel=[1, 3, 3, 1], channel_multiplier=1):
        ...
        # print(output_nc)
        self.to_rgb1 = ToRGB(self.channels[4], style_dim, output_nc, upsample=False)
        ...
        for i in range(3, self.log_size + 1):
            ...
            self.to_rgbs.append(ToRGB(out_channel, style_dim, output_nc))
    ...
    def forward(self, wa, alpha, feats):
        ...
        #print("latent", latent.shape, "out", out.shape)
        ...
        for conv1, conv2, to_rgb, to_flow, feat in zip(self.convs[::2], self.convs[1::2], self.to_rgbs,
            ...
            if out.size(2) == 8:
                ...
                if out.size(2) // 64 > 0 and hasattr(self, 'sft'):
            ...
            #print("out_warp", out_warp.shape, "skip", skip.shape)
            pyramid_recons.insert(0, skip)
            i += 2

        #img = skip

        return pyramid_recons
