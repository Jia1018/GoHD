...
class LandmarkSyncNet(nn.Module):
    def __init__(self, lm_dim=93):
        super(LandmarkSyncNet, self).__init__()

        self.audio_encoder = nn.Sequential(
            Conv1d(1600, 128, kernel_size=3, stride=1, padding=1),
    ...
    def forward(self, audio, mouth_lm): 
        # audio := (B, T=5, C=1600(20*80))
        # mouth_lm3d := (B, T=5, C=93((20+11)*3)) including mouth and jaw
        # mouth_lm2d := (B, T=5, C=62((20+11)*2)) including mouth and jaw
